...
const PLANS = [
  { id:'free', name:'Tiger Generosidade', price:'0', period:'Grátis', color:'var(--text-muted)', features:[{ok:true,txt:'15 questões por dia'},{ok:true,txt:'5 perguntas/dia com a IA TigerJus'},{ok:true,txt:'Mini-simulados + pergunta do dia'},{ok:true,txt:'Ranking, pontos e sequência diária'},{ok:false,txt:'Simulados completos'},{ok:false,txt:'Resumos e Índice Remissivo'}] },
  { id:'start', name:'Tiger Start', price:'4,99', period:'/mês', color:'var(--success)', features:[{ok:true,txt:'50 questões por dia'},{ok:true,txt:'20 perguntas/dia com a IA TigerJus'},{ok:true,txt:'Simulados completos no estilo OAB'},{ok:true,txt:'Flashcards de revisão'},{ok:true,txt:'Resumos rápidos (prévia da Lei Seca)'},{ok:false,txt:'Índice, PDF e Radar'}] },
  { id:'pro', name:'Tiger Pro', price:'9,99', period:'/mês', badge:'MAIS POPULAR', featured:true, color:'var(--gold)', features:[{ok:true,txt:'Questões ilimitadas — todos os modos'},{ok:true,txt:'40 perguntas/dia com a IA TigerJus'},{ok:true,txt:'Resumos completos por disciplina'},{ok:true,txt:'Índice Remissivo — ache temas em segundos'},{ok:true,txt:'Exportar PDF + flashcards avançados'},{ok:false,txt:'Radar TigerJus'}] },
  { id:'elite', name:'Tiger Elite', price:'24,99', period:'/mês', badge:'TOP', elite:true, color:'var(--orange)', features:[{ok:true,txt:'Tudo do Pro, sem limites'},{ok:true,txt:'80 perguntas/dia com a IA (o dobro do Pro)'},{ok:true,txt:'Radar TigerJus — temas que mais caem'},{ok:true,txt:'Lei Seca de memorização (exclusivo)'},{ok:true,txt:'Resumos completos + Índice + PDF'},{ok:true,txt:'Mini-simulados e flashcards ilimitados'}] },
]
