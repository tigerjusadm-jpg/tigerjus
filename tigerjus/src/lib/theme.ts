...
export const THEMES: Record<ThemeName, ThemeTokens> = {
  ...
  tech: {
    '--tj-bg':                '#060a12',
    '--tj-bg-secondary':      '#0a1020',
    '--tj-bg-tertiary':       '#0d1428',
    '--tj-card-bg':           'rgba(12,20,40,0.85)',
    '--tj-card-border':       'rgba(99,130,200,0.18)',
    '--tj-card-hover-border': 'rgba(99,130,200,0.5)',
    '--tj-card-glow':         'rgba(99,130,200,0.12)',
    '--tj-border':            'rgba(99,130,200,0.15)',
    '--tj-sidebar-bg':        '#050810',
    '--tj-sidebar-border':    'rgba(99,130,200,0.15)',
    '--tj-glow-color':        'rgba(99,130,200,0.2)',
